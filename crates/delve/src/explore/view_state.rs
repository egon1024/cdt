...
pub struct ViewStateController {
    ...
    pub show_fork_full_path_panel: bool,
    pub show_fork_sibling_panel: bool,
    pub highlighted_path: Option<Vec<usize>>,
...
impl ViewStateController {
    ...
    pub fn default_for_tree(tree: &ExploreTree) -> Self {
        ...
        Self {
            ...
            compare_fork: None,
            compare_row: 0,
            show_fork_full_path_panel: false,
            show_fork_sibling_panel: false,
